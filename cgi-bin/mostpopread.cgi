...
print "<html>\n";
print $myheader;
print "<head><title>Most Popular Readings</title></head>\n";
print "<body>\n";
if ($noframes) { TopTable("stats"); }
print "</body>\n";
print "<form action=\"mostpopread1.cgi";
print "?noframes" if ($noframes);
print "\" method=\"POST\">\n";
print "<p>Most Popular Readings over a given Period.\n";
...
print "<p>How many readings do you want retrieved?<br>\n";
print "<input type=text name=\"numreadings\" size=5 maxlength=5 value=\"20\">\n";
